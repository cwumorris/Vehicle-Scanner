  ...
  return (
    <div className="min-h-screen bg-background text-foreground px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Add New Vehicle</h1>
          <p className="text-muted-foreground mt-1">Fill in the details below. The QR code will download automatically.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input name="plate" placeholder="KBA 123X" value={form.plate} onChange={handleChange} required className="w-full h-11 rounded-md border border-border bg-input px-3 text-sm focus:outline-none focus:ring-4 focus:ring-ring" />
              </div>
              <div className="space-y-1">
            ...
            <div className="pt-2">
              <button disabled={createMutation.isPending} type="submit" className="inline-flex items-center justify-center h-11 px-5 rounded-md bg-blue-600 text-white font-semibold hover:bg-blue-500 disabled:opacity-60 active:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-400/40">
            ...
            <div className="space-y-4">
              ...
              {qrUrl && (
                <div className="flex justify-center">
                  <img 
                    src={qrUrl} 
                    alt="Vehicle QR Code" 
                    className="w-48 h-48 rounded border border-gray-200 dark:border-gray-700" 
                  />
                </div>
              )}
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full h-10 px-4 rounded-md border border-gray-300 dark:border-gray-600 text-foreground font-medium hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                  Close
                </button>
              </div>
